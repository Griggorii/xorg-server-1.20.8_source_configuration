...
ubuntu 20.04 , focal , linux , xorg-server , new update perfomance 14.06.2021 , не обрезанная до remmina ubuntu 20.04 gtk2-3 от griggroii , danger risk 21.04 not experiment onli graphics ditributive http://chng.it/WDfJZLPgZZ , считаю удачно вышло что я по графике отделился от дальнейших наворачиваний версии гт4 , гтк5 , гноме 40 сделав ее чуть чуть не совместимой с дальнейшими 21.04 , 22.04 тем самым мы посмотрим как те кто гоняться за версиями и не посчитавшими нужным возвести этот дистрибутив в мировые и соответственно отвести мне сумму на разработку теряют в функциях и прочих вещах возводя это в ранг прогресса и получая за это деньги , тем выше взлет тем хуже падение так что скачивайте мой дистрибутив http://chng.it/WDfJZLPgZZ и устанавливайте перебилд тем самым ускорив графику.

Не для новичков что бы не натворить лишнего бардака в системе после может не завестись система и надо все дорабатывать как пример как я разрабатывал в течений пяти лет операционную систему https://www.youtube.com/watch?v=GBAtFq2aD8E по этому работа очень сложная и любая выкладка таких наработок заняла бы миллионы человеко часов по этому тут я уже предоставляю почти готовую систему как та на которой еще не с паразитировали и нету черных рамок вокруг белых виджетов http://chng.it/WDfJZLPgZZ проблемы установки тут https://youtu.be/MVhZ_QZGxaQSource full https://github.com/Griggorii/xorg-server-1.20.8/releases/tag/xorg-serverDump ubuntu 20.04 objective libsxorg-server-1.20.8.tar.xz inpack /tmp$ sudo mv /usr/include/pciaccess.h /usr/include/xorg/ && sudo rm /usr/include/pciaccess.hOnly real technologies, not any fictional parasitic distributions all it corporation support real technology investments and donate dollar VISA 4817 7601 8112 4706 thanks
