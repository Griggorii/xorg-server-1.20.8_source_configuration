...
ubuntu 20.04 , focal , linux , xorg-server , new update perfomance 14.06.2021 , не обрезанная до remmina ubuntu 20.04 gtk2-3 от griggroii , danger risk 21.04 not experiment onli graphics ditributive http://chng.it/WDfJZLPgZZ опасно с другими дистрибутивами может быть не совместимо и флаги могут быть другими! Only https://github.com/Griggorii/Linux_OS20.04_V5_X64_By_Griggorii.iso_ubuntu_focal_fossa-linux-image-kernel-5.6.0-oem
